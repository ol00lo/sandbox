...
PYBIND11_MODULE(py_graph_pr, m)
{
    ...
    py::class_<g::INode, std::shared_ptr<g::INode>>(m, "INode")
        ...
        .def_static("factory", [](const std::string &classname, const std::string &nodename) {
    ...
    py::class_<g::Model>(m, "Model")
        .def(py::init<const std::vector<g::pnode_t>&,const std::vector<g::pnode_t>&>(),
    ...
    py::class_<g::OptimizationWorker>(m, "OptimizationWorker")
        .def(py::init<const g::Model&, g::LossType>(),
             py::arg("model"),py::arg("loss_type"))

        .def("set_optimizer",&g::OptimizationWorker::set_optimizer,
             py::arg("optimizer"))
        .def("train", &g::OptimizationWorker::train,
             py::arg("inputs"), py::arg("gt"))
        .def("validate", &g::OptimizationWorker::validate,
             py::arg("inputs"), py::arg("gt"))
        .def("commit", &g::OptimizationWorker::commit);

    // LossType
    py::enum_<g::LossType>(m, "LossType")
        .value("MSE", g::LossType::MSE);
    ...
    // SimpleDataGenerator
    py::class_<g::SimpleDataGenerator, g::IDataGenerator, std::shared_ptr<g::SimpleDataGenerator>>(m, "SimpleDataGenerator")
        .def(py::init<const std::vector<g::tvec_t>&, const std::vector<g::tvec_t>&, int, int>(),
             py::arg("inputs"),
             py::arg("outputs"),
             py::arg("batch_size") = 1,
             py::arg("seed")       = 0);
